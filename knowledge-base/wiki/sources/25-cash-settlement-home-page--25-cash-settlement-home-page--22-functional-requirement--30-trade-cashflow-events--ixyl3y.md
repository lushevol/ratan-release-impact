---
type: source
title: CN Drop 2 UAT Settlements Scenarios 2024
authors: []
year: 2024
url: ""
venue: ""
created: 2026-08-24
updated: 2026-08-24
tags: [cash-settlement, uat, cn-drop-2, trade-events, cashflows, murex, ratan, razor]
related: [cashflow-event-control, trade-event-undo-semantics, fo-hard-block-mo-soft-block, manual-and-automatic-refixing, ndirs-cny-leg-mapping, cashflow-lifecycle-state-model, released-settled-amendment-control, cashflow-netting-and-auto-un-netting, ratan-cashflow-acknowledgement-and-release-processing, cashflow-suppression-rules, nstp-rule-routing, ratan, razor, stella, lms, tds3, irs, ccs, ndf, scf, amh, cortex]
...
---
# CN Drop 2 UAT Settlements Scenarios 2024

## Summary

This source is a CN Drop 2 UAT scenario catalogue and payment-issue tracker for cash settlement and trade-event controls. It covers booking, amendments, cancellations, withdrawals, early termination, expiry, novation, portfolio reassignment, netting, payment release, undo behavior, and product-specific cashflow processing across [[entities/irs]], [[entities/ccs]], [[entities/ndf]], and [[entities/scf]].

The document should be treated as a test inventory and issue register, not as evidence that the full matrix passed. It contains no complete pass/fail record, execution date, test owner, or formal sign-off. Blank scenario rows do not establish successful execution.

## Systems and Scope

The scenarios concern [[entities/murex-211]], [[entities/ratan]], [[entities/razor]], [[entities/stella]], [[entities/lms]], and [[entities/tds3]]. The principal control boundary is payment release: many scenarios compare behavior before and after the original payment, cancellation, termination fee, or net payment is released.

The scope includes:

- Single-product and BTB3/5/7 bookings
- Inter-entity and intra-entity trades
- Backdated bookings and events
- Customized cashflows, coupons, spreads, and amortizing notionals
- Fees, early termination, novation, expiry, and portfolio reassignment
- Netting, auto-netting, suppression, and re-fixing
- MO Bulk Upload Tool bookings
- SCF-specific cashflow types
- RAZOR ACK/NACK and RATAN withdrawal processing

Explicit boundaries include that IMM roll is not applicable for China, close-out is out of scope for Rates and applies only to FX, and FX product portfolio reassignment is out of scope for CPT.
...
The issue tracker distinguishes closed items, pending enhancements, defects, and dropped items. A closed issue is evidence of tracker closure, but not necessarily formal regression validation. In particular:

- The Stella NDIRS auto-net issue was attributed to an environment failure followed by failed and reinstated payment flow.
- The TDS3 issue requires filtering a RATAN `status_update` message to prevent incorrect un-netting.
- The RAZOR NACK recovery enhancement proposes moving the status to `techfail`; ACK after NACK is explicitly unsupported in the source.
- The FT CPT undo issue was high priority and associated with a minor-version mismatch.
- The wording of the duplicate-cashflow issue conflicts with its comment, which states that no new resultant cashflow was generated.

The source therefore supports targeted operational findings but not a universal conclusion about settlement correctness or formal UAT sign-off.

## Related Wiki Topics

The source strengthens and provides concrete examples for:

- [[concepts/cashflow-lifecycle-state-model]]
- [[concepts/released-settled-amendment-control]]
- [[concepts/cashflow-netting-and-auto-un-netting]]
- [[concepts/ratan-cashflow-acknowledgement-and-release-processing]]
- [[concepts/cashflow-suppression-rules]]
- [[concepts/nstp-rule-routing]]
- [[entities/ratan]]
- [[entities/razor]]
- [[entities/stella]]
- [[entities/lms]]
...
It does not establish final architecture or production behavior because it is a UAT scenario and issue document rather than a signed-off design or production report.