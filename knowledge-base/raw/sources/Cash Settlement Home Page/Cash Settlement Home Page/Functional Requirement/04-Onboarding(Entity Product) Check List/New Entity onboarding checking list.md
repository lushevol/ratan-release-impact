...
| 12 | Include new branch in GUI Drop down - Cashflow Blotter (mandatory for each entity) - Dashboard (mandatory for each entity) | Need to be added for new entity | Config |
